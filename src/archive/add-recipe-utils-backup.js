...
setAttributes(body, {
  style: `background-image: url("https://images.unsplash.com/photo-1504388192519-fb4be897c4d0?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=634&q=80");
...
const addRowFunction = () => {
  ...
  setAttributes(bgColor, {
    style: `height: ${height}px; background-color: #f1f7fc; width: 80%; position:relative; opacity: 0.7;`,
  });
